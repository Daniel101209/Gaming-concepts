...
button_img=pygame.image.load("C:/Users/User/Desktop/gaming concepts/PRO GAME DEV/Flappy bird/images/restart.png")
...
#adding the images to the game
    ...
    if game_over == False and flying == True:
        ...
        if time_now - last_pipe > pipe_frequency:
            ...
            tope_pipe=Pipe(WIDTH,int(HEIGHT/2)+pipe_height,1)
            pipe_group.add(btm_pipe)
            pipe_group.add(tope_pipe)
            last_pipe=time_now
