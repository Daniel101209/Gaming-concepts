...
def draw():
    ...
    screen.draw.filled_rect(timer_box,"lime")
    screen.draw.filled_rect(skip_box,"maroon")
    ...
    screen.draw.textbox(marquee_message,marquee_box,color="sky blue")
    screen.draw.textbox(str(time_left),timer_box,color="red",shadow=(0.5,0.5),scolor="orange")
    screen.draw.textbox("skip",skip_box,color="violet",angle=-90)
    screen.draw.textbox(question[0].strip(),question_box,color="orange",shadow=(0.5,0.5),scolor="white")
